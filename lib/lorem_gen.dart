...
String sentence({int sentenceLength = -1, int numSentences = 1}) {
  int wordIndex;
  String sentence;
...
/// to generate.
String paragraph({int numSentences = -1, int numParagraphs = 1}) {
...
String text({int numParagraphs = -1, int numSentences = -1}) {
